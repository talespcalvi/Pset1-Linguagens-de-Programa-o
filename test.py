...
class TestInvertida(unittest.TestCase):
    ...
    def test_invertida_2(self):
        ...
        i = pset1.Imagem(4, 1,                       # Cria a imagem nas definições pedidas.
                         [29, 89, 136, 200])
        
        resultado = i.invertida()                    # Aplicação do filtro de inversão.

        esperado = pset1.Imagem(4, 1, 
                                [226, 166, 119, 55]) # Resultado esperado da imagem após aplicação do filtro.

        self.assertEqual(resultado, esperado)        # Compara o resultado com o resultado esperado.
